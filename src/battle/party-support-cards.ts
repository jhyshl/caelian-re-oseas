...
const SPECS: Record<string, PartyCardSpec> = {
  ...
  shadow_knight: { name: '影幕掩护', description: '我方全体获得6护盾与1层迅捷。', effects: [{ type: 'shield', value: 6, target: 'all_allies' }, { type: 'apply_buff', buff: 'swift', value: 1, turns: 1, target: 'all_allies' }] },
  ...
  wind_mage: { name: '同行顺风', description: '我方全体获得1层迅捷，持续2回合。', effects: [{ type: 'apply_buff', buff: 'swift', value: 1, turns: 2, target: 'all_allies' }] },
  ...
  dark_mage: { name: '暗幕庇佑', description: '我方全体获得10护盾与1层迅捷。', effects: [{ type: 'shield', value: 10, target: 'all_allies' }, { type: 'apply_buff', buff: 'swift', value: 1, turns: 1, target: 'all_allies' }] },
  ...
  mechanic: { name: '联防力场', description: '我方全体获得12护盾与1层迅捷。', effects: [{ type: 'shield', value: 12, target: 'all_allies' }, { type: 'apply_buff', buff: 'swift', value: 1, turns: 1, target: 'all_allies' }] },
  ...
  astrologer: { name: '双星守望', description: '我方全体获得8护盾与1层迅捷，持续2回合。', effects: [{ type: 'shield', value: 8, target: 'all_allies' }, { type: 'apply_buff', buff: 'swift', value: 1, turns: 2, target: 'all_allies' }] },
